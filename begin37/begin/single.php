		...
		<main id="main" class="site-main" role="main">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<nav class="nav-single wow fadeInUp">
					<?php
						if (get_previous_post( TRUE )) { previous_post_link( '%link','<span class="meta-nav ms bk"><span class="post-nav"><i class="be be-arrowleft"></i> ' . sprintf(__( '上一篇', 'begin' )) . '</span><br/>%title</span>', TRUE ); } else { echo "<span class='meta-nav ms bk'><span class='post-nav'>" . sprintf(__( '没有了', 'begin' )) . "<br/></span>" . sprintf(__( '已是最后文章', 'begin' )) . "</span>"; }
						if (get_next_post( TRUE )) { next_post_link( '%link', '<span class="meta-nav ms bk"><span class="post-nav">' . sprintf(__( '下一篇', 'begin' )) . ' <i class="be be-arrowright"></i></span><br/>%title</span>', TRUE ); } else { echo "<span class='meta-nav ms bk'><span class='post-nav'>" . sprintf(__( '没有了', 'begin' )) . "<br/></span>" . sprintf(__( '已是最新文章', 'begin' )) . "</span>"; }
					?>
					<div class="clear"></div>
				</nav>
