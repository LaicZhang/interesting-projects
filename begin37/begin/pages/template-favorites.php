...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		if( $query->have_posts() ) { ?>
		<article class="sites sites-all wow fadeInUp bk da">
			<div class="sites-cats bkx da">
				...
				<div class="sites-5">
					<?php while ($query->have_posts()) : $query->the_post();?>
						<?php if ( get_post_meta($post->ID, 'sites_img_link', true) ) { ?>
							...
							<span class="sites-title sites-title-img wow fadeInUp">
						...
						<?php } else { ?>
							...
							<?php } else { ?>
								<span class="sites-title wow fadeInUp"><a class="sites-title-t bk" href="<?php echo $sites_link; ?>" target="_blank" rel="external nofollow"><?php the_title(); ?></a></span>
							<?php } ?>
						<?php } ?>
					<?php endwhile; ?>
					<div class="clear"></div>
