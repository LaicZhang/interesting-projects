	...
	<div id="primary" class="content-area">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div id="barrager" class="barrager">
				...
				<div class="bgt">
					<a class="board-title da" href="<?php echo get_permalink($comment->comment_post_ID); ?>#anchor-comment-<?php echo $comment->comment_ID; ?>" title="发表在：<?php echo get_the_title($comment->comment_post_ID); ?>" rel="external nofollow">
			...
			<div id="mask"><div class="barrager-close bk hz" >关闭弹幕</div></div>
