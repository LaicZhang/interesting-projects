					...
					<form id="tou-form" method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>">
						<div class="basic-info">
							<p class="tou-label tou-title">
								...
								<input type="text" value="" name="tougao_title" id="tou-post-title" class="da" placeholder="必填，不得超过100个字符" required/>
							</p>
							<div class="basic-box">
								<p class="tou-label tou-info">
									<label for="tou-post-author">昵称：</label>
									<input type="text" value="" name="tougao_authorname" id="tou-post-author" class="da" placeholder="必填，不得超过20个字符" required/>
								</p>
								<p class="tou-label tou-info">
									<label for="tou-post-email">邮件：</label>
									<input type="text" value="" name="tougao_authoremail" id="tou-post-email" class="da" placeholder="必填，必须符合Email格式" required/>
								</p>
								<p class="tou-label tou-info">
									<label for="tou-post-web">网站：</label>
									<input type="text" value="" name="tougao_authorblog" id="tou-post-web" class="da" placeholder="选填"/>
								</p>
								<p class="tou-label tou-info">
									<label for="tou-post-web">电话：</label>
									<input type="text" value="" name="tougao_authorphone" id="tou-post-web" class="da" placeholder="选填"/>
								</p>
								<p class="tou-label tou-info">
									<label for="tou-post-web">QQ：</label>
									<input type="text" value="" name="tougao_authorqq" id="tou-post-web" class="da" placeholder="选填"/>
								</p>
								<p class="tou-label tou-info">
									<label for="tou-post-web">备注：</label>
									<input type="text" value="" name="tougao_authorremarks" id="tou-post-web" class="da" placeholder="选填"/>
								</p>
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="basic-info">
							...
							<p class="post-label-cat">
								<input type="text" value="" class="da" name="tougao_tags" placeholder="选填"/>
							</p>
						</div>
						<p>
