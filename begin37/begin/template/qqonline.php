...
<li class="qqonline">
	<?php if ( wp_is_mobile() ) { ?>
		<a class="qq-mobile" href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo zm_get_option('qq_id'); ?>&site=qq&menu=yes" target="_blank" rel="external nofollow"><i class="be be-qq"></i></a>
	<?php } else { ?>
	<div class="online">
		...
		<div class="qqonline-main ms bk">
			...
			<div class="nline-qq">
				...
				<a class="qq-wpa" href="https://wpa.qq.com/msgrd?v=3&uin=<?php echo zm_get_option('qq_id'); ?>&site=qq&menu=yes" title="QQ在线咨询" target="_blank" rel="external nofollow"><i class="be be-qq"></i><div class="clear"></div><?php echo zm_get_option('qq_id'); ?></a>
			</div>
			<div class="clear"></div>
