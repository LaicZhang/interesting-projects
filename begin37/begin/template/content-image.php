...
<?php if ( is_single() ) : ?>
<article id="post-<?php the_ID(); ?>" <?php post_class('ms bk'); ?>>
<?php else : ?>
...
<?php if (zm_get_option('post_tags') && is_single() ) { ?><div class="single-tag"><?php the_tags( '<ul class="wow fadeInUp"><li>', '</li><li>', '</li></ul>' ); ?></div><?php } ?>