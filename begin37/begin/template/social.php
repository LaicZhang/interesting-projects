...
<div id="social">
	<div class="social-main">
		<span class="like">
			<a href="javascript:;" data-action="ding" data-id="<?php the_ID(); ?>" title="<?php _e( '点赞', 'begin' ); ?>" class="da dingzan<?php if(isset($_COOKIE['zm_like_'.$post->ID])) echo ' done';?>"><i class="be be-thumbs-up-o"></i><?php _e( '赞', 'begin' ); ?> <i class="count">
		...
		<div class="share-sd">
			<span class="share-s"><a href="javascript:void(0)" id="share-s" class="da" title="<?php _e( '分享', 'begin' ); ?>"><i class="be be-share"></i><?php _e( '分享', 'begin' ); ?></a></span>
		...
		<div class="shang-p">
			...
			<?php } else { ?>
				...
				<span class="shang-s"><a class="da" title="<?php echo zm_get_option('alipay_t'); ?>"><?php echo zm_get_option('alipay_name'); ?></a></span>
			<?php } ?>
		</div>
	</div>
		<span class="clear"></span>
