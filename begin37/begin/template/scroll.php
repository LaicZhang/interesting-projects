...
<ul id="scroll" class="bgt">
	...
	<?php if (zm_get_option('read_night')) { ?>
		<ul class="night-day">
			<li><span class="night-main"><a class="m-night" onclick="switchMode()" title="<?php _e( '夜间模式', 'begin' ); ?>"><span class="m-moon"><span></span></span></a></span></li>
			<li><a class="m-day" onclick="switchMode()" title="<?php _e( '白天模式', 'begin' ); ?>"><i class="be be-loader"></i></a></li>
		</ul>
	<?php } ?>
	...
	<?php if (zm_get_option('qr_img')) { ?>
		<li class="qr-site"><a href="javascript:void(0)" class="qr ms" title="<?php _e( '本页二维码', 'begin' ); ?>"><i class="be be-qr-code"></i><span class="qr-img bk"><span id="output"><img class="alignnone" src="<?php echo zm_get_option('qr_icon'); ?>" alt="icon"/></span><span class="arrow arrow-z"><i class="be be-playarrow"></i></span><span class="arrow arrow-y"><i class="be be-playarrow"></i></span></span></a></li>
