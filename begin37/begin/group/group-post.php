...
<div class="g-row <?php if (zm_get_option('bg_21')) { ?>g-line<?php } ?> sort" name="<?php echo zm_get_option('group_post_s'); ?>">
	<div class="g-col">
		<div class="group-post-box">
			...
			<article id="post-<?php the_ID(); ?>" class="group-post-list grl wow fadeInUp">
				...
				<div class="group-post-content">
					...
					<div class="group-post-more bk da"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php _e( '详细查看', 'begin' ); ?></a></div>
				</div>
				<div class="clear"></div>
			</article>
