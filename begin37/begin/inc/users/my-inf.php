<div class="m-personal">
	...
	<div class="m-logout bgt"><a href="<?php echo wp_logout_url('index.php'); ?>"><?php _e( '登出', 'begin' ); ?></a></div>
	<div class="my-avatar">
		<?php global $current_user; wp_get_current_user();
			echo '<div class="m-img bgt">';
			if (zm_get_option('cache_avatar')):
				echo begin_avatar( $current_user->user_email, 64, '', $current_user->display_name); 
			else :
				echo get_avatar( $current_user->user_email, 64, '', $current_user->display_name); 
			endif;
