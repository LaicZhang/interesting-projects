...
function time_line( $atts, $content = null ) {
	...
	return '<div class="timeline">'.do_shortcode( $clean ).'</div>';
}
...
function gallery($atts, $content=null){
	return '<div id="slider-single" class="slider-single">'.do_shortcode(''.do_shortcode( $content ).'').'</div>';
}

// 下载按钮
function button_a($atts, $content = null) {
	return '<div class="down"><a class="d-popup" title="下载链接" href="#down-file"><i class="be be-download"></i>下载地址</a><div class="clear"></div></div>';
}

// 弹窗下载
function button_b($atts, $content = null) {
	return '<div class="down"><a class="d-popup" title="下载链接" href="#down-file" data-fancybox="gallery"><i class="be be-download"></i>'.do_shortcode(''.do_shortcode( $content ).'').'</a><div class="clear"></div></div>';
}
...
function cn_en($atts, $content=null) {
	$return = '<span class="cnen">';
	$return .= do_shortcode( $content );
	$return .= '</span>';
	return $return;
}

add_shortcode('en' , 'cn_en');
...
// 图标字体
function begin_font_shortcode( $atts ) {
...
function show_more($atts, $content = null) {
	return '<span class="show-more" title="' . (__( '文字折叠', 'begin' )) . '"><span><i class="be be-arrowdown"></i>' . sprintf(__( '展开', 'begin' )) . '</span></span>';
}
...
function wplist_shortcode($atts, $content = '') {
	...
	$out = '<div class="wplist-item bk"><a href="' . $atts['link'] . '" target="_blank" isconvert="1" rel="nofollow" >';
