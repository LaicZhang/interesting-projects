...
jQuery(document).ready(function() {
	...
	jQuery('#blog_special').click(function() {
		jQuery('#section-blog_special_id, #section-blog_specialid, #blog_specialid').fadeToggle(400);
	});
	if (jQuery('#blog_special:checked').val() !== undefined) {
		jQuery('#section-blog_special_id, #section-blog_specialid, #blog_specialid').show();
	}
	...
	jQuery('#group_tab').click(function() {
		jQuery('#section-anli_t, #section-anli_id, #section-cp_t, #section-cp_id, #section-sb_t, #section-sb_id, #section-group_tab_n, #section-group_tab_s, #section-bg_17, #section-by_t, #section-by_id, #section-group_tab_meta').fadeToggle(400);
	});

	if (jQuery('#group_tab:checked').val() !== undefined) {
		jQuery('#section-anli_t, #section-anli_id, #section-cp_t, #section-cp_id, #section-sb_t, #section-sb_id, #section-group_tab_n, #section-group_tab_s, #section-bg_17, #section-by_t, #section-by_id, #section-group_tab_meta').show();
	}
	...
	jQuery('#menu_post').click(function() {
		jQuery('#section-menu_cat_cover_md, #section-menu_cat_cover_id, #section-menu_post_sm, #section-menu_cat_e_id, #section-menu_post_my').fadeToggle(400);
	});
	if (jQuery('#menu_post:checked').val() !== undefined) {
		jQuery('#section-menu_cat_cover_md, #section-menu_cat_cover_id, #section-menu_post_sm, #section-menu_cat_e_id, #section-menu_post_my').show();
	}
	...
	jQuery('#copyright').click(function() {
		jQuery('#section-copyright_avatar, #section-copyright_statement, #section-copyright_indicate, #section-copyright_case').fadeToggle(400);
	});

	if (jQuery('#copyright:checked').val() !== undefined) {
		jQuery('#section-copyright_avatar, #section-copyright_statement, #section-copyright_indicate, #section-copyright_case').show();
	}
	...
	jQuery('#post_meta_inf').click(function() {
		jQuery('#section-meta_b, #section-meta_author_single, #section-meta_author, #section-author_hide, #section-tts_play, #section-print_on, #section-word_count, #section-reading_time, #section-word_time, #section-baidu_record, #section-meta_time, #section-meta_time_second, #section-post_replace, #section-post_tags').fadeToggle(400);
	});

	if (jQuery('#post_meta_inf:checked').val() !== undefined) {
		jQuery('#section-meta_b, #section-meta_author_single, #section-meta_author, #section-author_hide, #section-tts_play, #section-print_on, #section-word_count, #section-reading_time, #section-word_time, #section-baidu_record, #section-meta_time, #section-meta_time_second, #section-post_replace, #section-post_tags').show();
	}

	jQuery('#comment_related').click(function() {
		jQuery('#section-comment_ajax, #section-at, #section-qq_info, #section-mail_notify, #section-qt, #section-no_email, #section-no_comment_url, #section-not_comment_form, #section-refused_spam, #section-vip, #section-comment_floor, #section-embed_img, #section-emoji_show, #section-comment_html, #section-del_comment, #section-comment_url, #section-infinite_comment, #section-check_admin, #section-admin_name, #section-admin_email, #section-close_comments, #section-login_comment, #section-comment_to').fadeToggle(400);
	});

	if (jQuery('#comment_related:checked').val() !== undefined) {
		jQuery('#section-comment_ajax, #section-at, #section-qq_info, #section-mail_notify, #section-qt, #section-no_email, #section-no_comment_url, #section-not_comment_form, #section-refused_spam, #section-vip, #section-comment_floor, #section-embed_img, #section-emoji_show, #section-comment_html, #section-del_comment, #section-comment_url, #section-infinite_comment, #section-check_admin, #section-admin_name, #section-admin_email, #section-close_comments, #section-login_comment, #section-comment_to').show();
	}
	...
	jQuery('#follow_button').click(function() {
		jQuery('#section-scroll_z, #section-scroll_h, #section-scroll_b, #section-read_night, #section-scroll_s, #section-scroll_c, #section-gb2, #section-mobile_scroll').fadeToggle(400);
	});

	if (jQuery('#follow_button:checked').val() !== undefined) {
		jQuery('#section-scroll_z, #section-scroll_h, #section-scroll_b, #section-read_night, #section-scroll_s, #section-scroll_c, #section-gb2, #section-mobile_scroll').show();
	}

	jQuery('#h_cat_cover').click(function() {
		jQuery('#section-cat_tag_cover, #section-cat_cover_id').fadeToggle(400);
	});

	if (jQuery('#h_cat_cover:checked').val() !== undefined) {
		jQuery('#section-cat_tag_cover, #section-cat_cover_id').show();
	}

	jQuery('#setup_email_show').click(function() {
		jQuery('#section-setup_email_smtp, #section-email_name, #section-email_smtp, #section-email_port, #section-email_account, #section-email_authorize, #section-email_recieve, #section-email_ssl_tls').fadeToggle(400);
	});

	if (jQuery('#setup_email_show:checked').val() !== undefined) {
		jQuery('#section-setup_email_smtp, #section-email_name, #section-email_smtp, #section-email_port, #section-email_account, #section-email_authorize, #section-email_recieve, #section-email_ssl_tls').show();
	}

	jQuery('#contact_us').click(function() {
		jQuery('#section-contact_s, #section-weixing_us, #section-weixing_us_t, #section-usqq_id, #section-usqq_t, #section-usshang_url, #section-usshang_t, #section-us_phone, #section-us_phone_t').fadeToggle(400);
	});

	if (jQuery('#contact_us:checked').val() !== undefined) {
		jQuery('#section-contact_s, #section-weixing_us, #section-weixing_us_t, #section-usqq_id, #section-usqq_t, #section-usshang_url, #section-usshang_t, #section-us_phone, #section-us_phone_t').show();
	}

	jQuery('#ajax_tabs').click(function() {
		jQuery('#section-tab_b_n, #section-tabs_mode, #section-tab_b_a, #section-tab_b_a_id, #section-tab_b_b, #section-tab_b_b_id, #section-tab_b_c, #section-tab_b_c_id, #section-tab_b_d, #section-tab_b_d_id').fadeToggle(400);
	});

	if (jQuery('#ajax_tabs:checked').val() !== undefined) {
		jQuery('#section-tab_b_n, #section-tabs_mode, #section-tab_b_a, #section-tab_b_a_id, #section-tab_b_b, #section-tab_b_b_id, #section-tab_b_c, #section-tab_b_c_id, #section-tab_b_d, #section-tab_b_d_id').show();
	}
