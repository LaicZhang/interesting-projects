...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => '添加外链图片域名，多个域名用英文逗号","隔开',
		'desc' => '',
		'id' => 'allowed_sites',
		'class' => 'be_ico',
		'std' => 'wx3.sinaimg.cn,s0.wordpress.com,ww1.sinaimg.cn,ww2.sinaimg.cn,ww3.sinaimg.cn,ww4.sinaimg.cn,wx1.sinaimg.cn,wx2.sinaimg.cn,wx4.sinaimg.cn,n.sinaimg.cn,s2.ax1x.com',
		'type' => 'textarea'
	);
...
*/
	...
	$options[] = array(
		...
		'class' => 'hidden',
		'std' => '<strong>除非特殊声明，本站文章均为原创，转载请务必保留本文链接</strong>',
		'type' => 'textarea'
	);
...
// 公司主页
	...
	$options[] = array(
		'desc' => '设置 wp-content/uploads/avatar 目录权限为 755 或 777',
		'id' => 'avatar_sm',
		'class' => 'hidden'
	);
	...
	$options[] = array(
		...
		'id' => '404_c',
		'class' => '',
		'std' => '亲，该网页可能搬家了！<br /><a href="#" target="_blank"><img src="https://s2.ax1x.com/2019/06/12/V2oNSf.jpg" alt="广告也精彩" /></a>',
		'type' => 'textarea'
	);
