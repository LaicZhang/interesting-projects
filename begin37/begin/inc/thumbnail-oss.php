	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
	...
	if ( get_post_meta($post->ID, 'long_thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,h_' . zm_get_option('img_k_h') . ' ,w_' . zm_get_option('img_k_w') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_i_w') . ' ,h_' . zm_get_option('img_i_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
	...
	if ( get_post_meta($post->ID, 'small', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_v_w') . ' ,h_' . zm_get_option('img_v_h') . ', limit_0" alt="' . $post->post_title .'" /><i class="be be-play"></i></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_t_w') . ' ,h_' . zm_get_option('img_t_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
...
function format_image_thumbnail() {
	...
	preg_match_all('/<img.*?(?: |\\t|\\r|\\n)?src=[\'"]?(.+?)[\'"]?(?:(?: |\\t|\\r|\\n)+.*?)?>/sim', $content, $strResult, PREG_PATTERN_ORDER);
	if (zm_get_option('lazy_s')) {
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="' . get_template_directory_uri() . '/img/loading.png" data-original="'.$strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="' . get_template_directory_uri() . '/img/loading.png" data-original="'.$strResult[1][1] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="' . get_template_directory_uri() . '/img/loading.png" data-original="'.$strResult[1][2] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="' . get_template_directory_uri() . '/img/loading.png" data-original="'.$strResult[1][3] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div></div>';
	} else {
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.$strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.$strResult[1][1] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.$strResult[1][2] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
		echo '<div class="f4"><div class="format-img"><a href="'.get_permalink().'"><img src="'.$strResult[1][3] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div></div>';
	}
}
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('grid_w') . ' ,h_' . zm_get_option('grid_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_full_w') . ' ,h_' . zm_get_option('img_full_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
...
function zm_sites_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		$n = count($strResult[1]);
		if($n > 0) {
			echo '<div class="load"><a href="'.$sites_img_link.'" target="_blank" rel="external nofollow"><img src="' . get_template_directory_uri() . '/img/loading.png" data-original="' . $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a></div>';
		}
	}
}
...
function gr_wd_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'wd_img', true) ) {
		...
		if($n > 0) {
			...
			echo $strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_700& ,h_380, limit_0" alt="' . $post->post_title .'" /></a>';
			if (zm_get_option('lazy_s')) {
				echo '</span>';
			}
		} else { 
...
function zm_widge_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'widge_img', true) ) {
		...
		$n = count($strResult[1]);
		if($n > 0) {
			echo '<a href="'.get_permalink().'"><img src="'.$strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_s_w') . ' ,h_' . zm_get_option('img_s_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
		}
	}
}
...
function zm_thumbnail_scrolling() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			$n = count($strResult[1]);
			if($n > 0) {
				echo '<a href="'.get_permalink().'"><img class="owl-lazy" data-src="'.$strResult[1][0] . '?x-oss-process=image/resize,m_fill,w_' . zm_get_option('img_w') . ' ,h_' . zm_get_option('img_h') . ', limit_0" alt="' . $post->post_title .'" /></a>';
			} else { 
				if ( zm_get_option('rand_img_n') ) {
					$random = mt_rand(1, zm_get_option('rand_img_n'));
				} else { 
