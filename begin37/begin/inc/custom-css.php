...
if ($link_color) {
$styles .= "a:hover, .single-content p a, .single-content p a:visited, .top-menu a:hover, #site-nav .down-menu > .current-menu-item > a, #site-nav .down-menu > .current-post-ancestor > a, #user-profile a:hover, .entry-meta a, .entry-meta-no a, .filter-tag:hover {color: #" . $link_color . ";}
...
function adapt_width(){
	if (zm_get_option("adapt_width")) {
		...
		echo "<style>@media screen and (min-width: 1600px) {#content, .header-sub, .nav-top, #top-menu, #navigation-top, #mobile-nav, #main-search, .bread, .footer-widget, .links-box, .g-col, .links-group #links, .logo-box, #menu-container-o {width: " . $width . "%;}@media screen and (max-width: " . $width . "%) {#content, .bread, .footer-widget, .links-box, #top-menu, #navigation-top, .nav-top, #main-search, #search-main, #mobile-nav, .header-sub, .bread, .g-col, .links-group #links {width: 98%;}}}</style>";
	}
}
...
// section_bg
function carousel_bg(){echo'<style>#section-gtg {background: url('.zm_get_option('carousel_bg_img').') no-repeat;background-position: center center;background-size: cover;width: 100%;background-attachment: fixed;}</style>';}
function service_bg(){echo'<style>#service-bg {background: url('.zm_get_option('service_bg_img').') no-repeat;background-position: center center;background-size: cover;width: 100%;background-attachment: fixed;}</style>';}
function top_bg(){echo'<style>.header-main-o {background: #fff url('.zm_get_option('top_bg').') no-repeat;background-position: top center;background-size: auto 300px;}</style>';}
