...
if (function_exists('register_sidebar')){
	register_sidebar( array(
		...
		'before_widget' => '<aside id="%1$s" class="widget %2$s wow fadeInUp ms bk">',
		'after_widget'  => '<div class="clear"></div></aside>',
		'before_title'  => '<h3 class="widget-title bkx da"><span class="title-i"><span></span><span></span><span></span><span></span></span>',
		'after_title'   => '</h3>',
	) );
	...
	register_sidebar( array(
		...
		'id'            => 'cms-two',
		'description'   => '显示在首页CMS杂志布局',
		'before_widget' => '<div class="xl2"><aside id="%1$s" class="widget %2$s wow fadeInUp ms bk">',
	...
	register_sidebar( array(
		...
		'id'            => 'cms-three',
		'description'   => '显示在首页CMS杂志布局',
		'before_widget' => '<div class="xl3"><aside id="%1$s" class="widget %2$s wow fadeInUp ms bk">',
		'after_widget'  => '<div class="clear"></div></aside></div>',
		'before_title'  => '<h3 class="widget-title bkx da"><span class="title-i"><span></span><span></span><span></span><span></span></span>',
		'after_title'   => '</h3>',
	) );
...
if (zm_get_option('visual_editor')) {
	...
	if (zm_get_option('p_first') ) {add_editor_style( 'css/editor.css' );}
}
// Block styles
...
function begin_scripts() {
	...
	wp_enqueue_script( 'owl', get_template_directory_uri() . "/js/owl.carousel.min.js", array(), version, false );
	...
	wp_enqueue_script( 'ajax_tab', get_template_directory_uri() . "/js/begin-tab.js", array('jquery'), version, true );
	wp_localize_script( 'ajax_tab', 'ajax_tab', array( 'ajax_url' => admin_url( 'admin-ajax.php' )));
