...
function begin_orderby() {
	echo '<div class="sorting bgt"><ul class="bgt"><li class="order bgt"><a href="javascript:void(0)" title="' . sprintf(__( '文章排序', 'begin' )) . '"><i class="be be-sort"></i></a></li></ul>';
	echo '<ul class="order-box bgt">';
	echo '<li><a href="';
	echo bloginfo('url');
