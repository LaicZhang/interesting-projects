...
function zm_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
		...
		if ( has_post_thumbnail() ) {
			...
			if (zm_get_option('clipping_thumbnails')) {
				...
				if (zm_get_option('lazy_s')) {
					echo '<img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.$full_image_url[0].'" alt="'.get_the_title().'">';
				} else {
			...
			if($n > 0 && !get_post_meta( $post->ID, 'rand_img', true )) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
...
function zm_long_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'long_thumbnail', true) ) {
		...
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_k_w').'&h='.zm_get_option('img_k_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
			echo '<a href="'.get_permalink().'"><img src="';
		}
		if (zm_get_option('manual_thumbnail')) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0 && !get_post_meta( $post->ID, 'rand_img', true )) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_k_w').'&h='.zm_get_option('img_k_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_k_w').'&h='.zm_get_option('img_k_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
						echo '<a href="'.get_permalink().'"><img src="'. $src .'" alt="'.$post->post_title .'" /></a>';
					}
				}
...
function img_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		$image = get_post_meta($post->ID, 'thumbnail', true);
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_i_w').'&h='.zm_get_option('img_i_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
			echo '<a href="'.get_permalink().'"><img src="';
		}
		if (zm_get_option('manual_thumbnail')) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_i_w').'&h='.zm_get_option('img_i_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_i_w').'&h='.zm_get_option('img_i_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
						echo '<a href="'.get_permalink().'"><img src="'. $src .'" alt="'.$post->post_title .'" /></a>';
					}
				}
...
function videos_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'small', true) ) {
		...
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a class="videos" href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_v_w').'&h='.zm_get_option('img_v_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
		...
		if ( has_post_thumbnail() ) {
			...
			if (zm_get_option('clipping_thumbnails')) {
				...
				if (zm_get_option('lazy_s')) {
					echo '<img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_v_w').'&h='.zm_get_option('img_v_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.$full_image_url[0].'" alt="'.get_the_title().'">';
				} else {
					the_post_thumbnail('content', array('alt' => get_the_title()));
				}
			}
			...
			if($n > 0) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_v_w').'&h='.zm_get_option('img_v_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /><i class="be be-play"></i></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a class="videos" href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_v_w').'&h='.zm_get_option('img_v_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /><i class="be be-play"></i></a></span>';
					} else {
...
function tao_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		$image = get_post_meta($post->ID, 'thumbnail', true);
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_t_w').'&h='.zm_get_option('img_t_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
			echo '<a href="'.get_permalink().'"><img src="';
		}
		if (zm_get_option('manual_thumbnail')) {
		...
		if ( has_post_thumbnail() ) {
			...
			if (zm_get_option('clipping_thumbnails')) {
				...
				if (zm_get_option('lazy_s')) {
					echo '<img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_t_w').'&h='.zm_get_option('img_t_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.$full_image_url[0].'" alt="'.get_the_title().'">';
				} else {
			...
			if($n > 0) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_t_w').'&h='.zm_get_option('img_t_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_t_w').'&h='.zm_get_option('img_t_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
						echo '<a href="'.get_permalink().'"><img src="'. $src .'" alt="'.$post->post_title .'" /></a>';
					}
				}
...
function format_image_thumbnail() {
	...
	preg_match_all('/<img.*?(?: |\\t|\\r|\\n)?src=[\'"]?(.+?)[\'"]?(?:(?: |\\t|\\r|\\n)+.*?)?>/sim', $content, $strResult, PREG_PATTERN_ORDER);
	if (zm_get_option('lazy_s')) {
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][1].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][2].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a></div></div></div>';
		echo '<div class="f4"><div class="format-img"><div class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][3].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a></div></div></div>';
	} else {
...
function zm_grid_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		$image = get_post_meta($post->ID, 'thumbnail', true);
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('grid_w').'&h='.zm_get_option('grid_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
			echo '<a href="'.get_permalink().'"><img src="';
		}
		if (zm_get_option('manual_thumbnail')) {
		...
		if ( has_post_thumbnail() ) {
			...
			if (zm_get_option('clipping_thumbnails')) {
				...
				if (zm_get_option('lazy_s')) {
					echo '<img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('grid_w').'&h='.zm_get_option('grid_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.$full_image_url[0].'" alt="'.get_the_title().'">';
				} else {
					the_post_thumbnail('content', array('alt' => get_the_title()));
				}
			}
			...
			if($n > 0 && !get_post_meta( $post->ID, 'rand_img', true )) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('grid_w').'&h='.zm_get_option('grid_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('grid_w').'&h='.zm_get_option('grid_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
						echo '<a href="'.get_permalink().'"><img src="'. $src .'" alt="'.$post->post_title .'" /></a>';
					}
				}
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0 && !get_post_meta( $post->ID, 'rand_img', true )) {
				...
				echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_full_w').'&h='.zm_get_option('img_full_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
				if (zm_get_option('lazy_s')) {
					echo '</span>';
				}
			} else { 
...
function zm_sites_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		$n = count($strResult[1]);
		if($n > 0) {
			echo '<div class="load"><a href="'.$sites_img_link.'" target="_blank" rel="external nofollow"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('sites_w').'&h='.zm_get_option('sites_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a></div>';
		}
	}
}
...
function zm_sites_shot_img() {
	...
	if (zm_get_option('shot_thumbnail')) {
		echo '<img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('sites_w').'&h='.zm_get_option('sites_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original=';
...
function gr_wd_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'wd_img', true) ) {
		...
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w=700&h=380&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
			echo '<a href="'.get_permalink().'"><img src="';
		}
		if (zm_get_option('manual_thumbnail')) {
		...
		if($n > 0) {
			...
			echo get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w=700&h=380&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
			if (zm_get_option('lazy_s')) {
				echo '</span>';
			}
		} else { 
			...
			if (zm_get_option('clipping_rand_img')) {
				...
				if (zm_get_option('lazy_s')) {
					echo '<span class="load"><a href="'.get_permalink().'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w=700&h=380&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
				} else {
					echo '<a href="'.get_permalink().'"><img src="'. $src .'" alt="'.$post->post_title .'" /></a>';
				}
			}
...
function zm_thumbnail_link() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		$image = get_post_meta($post->ID, 'thumbnail', true);
		if (zm_get_option('lazy_s')) {
			echo '<span class="load"><a href="'.$direct.'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="';
		} else {
		...
		if ( has_post_thumbnail() ) {
			...
			if($n > 0 && !get_post_meta( $post->ID, 'rand_img', true )) {
				...
				if (zm_get_option('clipping_rand_img')) {
					...
					if (zm_get_option('lazy_s')) {
						echo '<span class="load"><a href="'.$direct.'"><img src="'. get_template_directory_uri().'/prune.php?src=' . get_template_directory_uri() . '/img/loading.png&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" data-original="'. $src .'" alt="'.$post->post_title .'" /></a></span>';
					} else {
...
function zm_widge_thumbnail() {
	...
	if ( get_post_meta($post->ID, 'widge_img', true) ) {
		...
		$n = count($strResult[1]);
		if($n > 0) {
			echo '<a href="'.get_permalink().'"><img src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_s_w').'&h='.zm_get_option('img_s_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
		}
	}
}
...
function zm_thumbnail_scrolling() {
	...
	if ( get_post_meta($post->ID, 'thumbnail', true) ) {
		...
		if ( has_post_thumbnail() ) {
			...
			$n = count($strResult[1]);
			if($n > 0) {
				echo '<a href="'.get_permalink().'"><img class="owl-lazy" data-src="'.get_template_directory_uri().'/prune.php?src='.$strResult[1][0].'&w='.zm_get_option('img_w').'&h='.zm_get_option('img_h').'&a='.zm_get_option('crop_top').'&zc=1" alt="'.$post->post_title .'" /></a>';
			} else { 
				if ( zm_get_option('rand_img_n') ) {
					$random = mt_rand(1, zm_get_option('rand_img_n'));
				} else { 
