...
<p>
	<label for="user_pwd1"><?php _e( '密码(至少6位)*', 'begin' ); ?></label><br />
	<input id="user_pwd1" class="input da" type="password" size="25" value="" name="user_pass" required="required" />
</p>
<p>
	<label for="user_pwd2"><?php _e( '重复密码*', 'begin' ); ?></label><br />
	<input id="user_pwd2" class="input da" type="password" size="25" value="" name="user_pass2" required="required" />
</p>
