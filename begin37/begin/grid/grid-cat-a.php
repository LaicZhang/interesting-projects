...
<?php $display_categories = explode(',',zm_get_option('grid_cat_a_id') ); foreach ($display_categories as $category) { ?>
	...
	<div class="grid-cat-box wow fadeInUp">
		<div class="grid-cat-title-box">
			<h3 class="grid-cat-title wow fadeInUp"><a href="<?php echo get_category_link($category);?>" title="<?php _e( '更多', 'begin' ); ?>"><?php single_cat_title(); ?></a></h3>
			<?php if (zm_get_option('grid_cat_a_child')) { ?>
			<ul class="grid-cat_chi-child wow fadeInUp">
