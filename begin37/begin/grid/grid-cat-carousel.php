...
<div class="grid-carousel-box wow fadeInUp">
	<?php
	...
	<div class="grid-cat-title-box">
		<h3 class="grid-cat-title wow fadeInUp"><a href="<?php echo $cat_links; ?>" title="<?php _e( '更多', 'begin' ); ?>"><?php single_cat_title(); ?></a></h3>
	</div>
	<?php } wp_reset_query(); ?>
	<div class="clear"></div>
