...
<div class="grid-cat-box wow fadeInUp">
<?php $recent = new WP_Query( array( 'posts_per_page' => zm_get_option('grid_cat_news_n'), 'category__not_in' => explode(',',zm_get_option('not_news_n')), 'post__not_in' => $do_not_top, 'paged' => $paged ) ); ?>
	<div class="grid-cat-new-box">
		<div class="grid-cat-title-box">
			<h3 class="grid-cat-title wow fadeInUp"><?php _e( '最近更新', 'begin' ); ?></h3>
