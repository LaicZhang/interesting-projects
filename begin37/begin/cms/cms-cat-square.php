...
<div class="cms-cat-square wow fadeInUp sort" name="<?php echo zm_get_option('cat_square_s'); ?>">
	...
	<h3 class="cat-square-title bkxw">
	...
	<div class="cat-g5">
		<?php while ( have_posts() ) : the_post(); ?>
			<article id="post-<?php the_ID(); ?>" <?php post_class(' sup bk'); ?>>
