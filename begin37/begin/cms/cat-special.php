...
<div class="cat-cover-box sort" name="1">
	<?php $posts = get_posts( array( 'post_type' => 'any', 'orderby' => 'menu_order', 'include' => zm_get_option('cms_special_id'), 'ignore_sticky_posts' => 1 ) ); if($posts) : foreach( $posts as $post ) : setup_postdata( $post ); ?>
		<div class="cover4x">
			<div class="cat-cover-main wow fadeInUp ms bk">
