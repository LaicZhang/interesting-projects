...
<div class="line-tab sort" name="<?php echo zm_get_option('cms_edd_s'); ?>">
	<div class="img-tab-site wow fadeInUp">
		<div id="img-tab" class="img-tab-product ms bk">
			...
			<div class="img-tab-bd img-dom-display wow fadeIn">
				...
				<div class="img-tab-bd-con img-current">
					...
					?>
					<article id="post-<?php the_ID(); ?>" class="w4 x4 wow fadeIn">
						<div class="picture">
