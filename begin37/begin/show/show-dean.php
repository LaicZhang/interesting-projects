	...
	<div class="g-col">
		<div class="deanm">
			...
			<div class="deanm-main wow fadeInUp">
				<div class="deanm deanmove bk da">
					...
					<div class="deanquan">
						<div class="de-back">
							...
							<div class="de-b bgt"><?php echo $ss_a_c; ?></div>
						</div>
					</div>
				...
				<div class="deanm deanmove bk da">
					...
					<div class="deanquan">
						<div class="de-back">
							...
							<div class="de-b bgt"><?php echo $ss_b_c; ?></div>
						</div>
					</div>
				...
				<div class="deanm deanmove bk da">
					...
					<div class="deanquan">
						<div class="de-back">
							...
							<div class="de-b bgt"><?php echo $ss_c_c; ?></div>
						</div>
					</div>
				...
				<div class="deanm deanmove bk da">
					...
					<div class="deanquan">
						<div class="de-back">
							...
							<div class="de-b bgt"><?php echo $ss_d_c; ?></div>
						</div>
					</div>
