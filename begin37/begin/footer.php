		...
		<div class="site-info">
			...
			<div class="add-info">
				...
				<?php if ( ! zm_get_option('yb_info') == '' ) { ?>
					<span class="yb-info">
						<a href="<?php echo zm_get_option('yb_url'); ?>" rel="bookmark"><?php if ( ! zm_get_option('yb_img') == '' ) { ?><img src="<?php echo zm_get_option('yb_img'); ?>"><?php } ?><?php echo zm_get_option('yb_info'); ?></a>
					</span>
				<?php } ?>
			</div>

		<?php if (zm_get_option('web_queries')) { ?><?php if(function_exists('queries')) queries(true) ;?><?php } ?>
		</div><!-- .site-info -->
